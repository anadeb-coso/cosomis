...
urlpatterns = [
    ...
    path('ptba/<int:pk>/copy/', views_ptba.AnnualWorkPlanCopyView.as_view(), name='annual_work_plan_copy'),
    ...
    path('supporting-document/<int:pk>/sheet/', views_supporting_document.SupportingDocumentActivitySheetView.as_view(), name='supporting_document_activity_sheet'),
    ...
    path('supporting-document/<int:pk>/download/', views_supporting_document.SupportingDocumentFileDownloadView.as_view(), name='supporting_document_file_download'),
    ...
    path('supporting-document-activity/<int:supporting_document_activity_pk>/files/edit/', views_supporting_document.SupportingDocumentActivityFilesUpdateView.as_view(), name='supporting_document_activity_files_edit'),
    ...
    path('supporting-document-activity-file/<int:pk>/download/', views_supporting_document.SupportingDocumentActivityFileDownloadView.as_view(), name='supporting_document_activity_file_download'),
]